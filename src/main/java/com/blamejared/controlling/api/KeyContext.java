...
public abstract class KeyContext {
     ...
     * <p>
     * Defaults to {@code true}, which is always safe: failing to warn a player of a potential clash is worse than
     * warning them spuriously. Override only to narrow it, and only when {@link #isActive()} makes the two contexts
     * impossible to activate at the same time. Every implementation of this method should return {@code true} when
     * {@code other == this}, since every context conflicts with itself.
     * <p>
