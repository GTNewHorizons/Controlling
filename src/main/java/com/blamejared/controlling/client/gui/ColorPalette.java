...
public enum ColorPalette {
    ...
    public final int keyChord;
    public final int keySelected;
    public final int keyNormal;
    public final int keyHover;
    public final int keyDisabled;
    /** Border marking a key barred from the selected binding's chord. */
    public final int chordBlockedBorder;
    ...
    ColorPalette(int keyBound, int keyConflict, int keyChord, int keySelected, int keyNormal, int keyHover,
            int keyDisabled, int chordBlockedBorder, int contextInGame, int contextGui, int contextCustom,
        ...
        this.chordBlockedBorder = chordBlockedBorder;
        ...
        this.legendColors = new int[] { keyBound, keyConflict, keyChord, keySelected, keyDisabled, keyNormal };
    }
